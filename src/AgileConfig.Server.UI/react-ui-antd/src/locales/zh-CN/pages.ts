export default {
  ...
  // Backup & Restore
  'pages.backup.title': '备份与还原',
  'pages.backup.backup.title': '备份',
  'pages.backup.backup.create': '创建备份',
  'pages.backup.backup.creating': '正在创建备份',
  'pages.backup.backup.create_success': '备份创建成功',
  'pages.backup.backup.create_fail': '备份创建失败',
  'pages.backup.backup.directory': '备份目录',
  'pages.backup.backup.latest': '最新备份',
  'pages.backup.backup.appCount': '个应用',
  'pages.backup.backup.download': '下载',
  'pages.backup.restore.title': '还原',
  'pages.backup.restore.upload': '上传备份文件',
  'pages.backup.restore.uploadTip': '点击或拖拽文件到此区域上传',
  'pages.backup.restore.uploadDesc': '仅支持 .zip 格式的备份文件',
  'pages.backup.restore.history': '历史备份',
  'pages.backup.restore.fileName': '文件名',
  'pages.backup.restore.fileSize': '文件大小',
  'pages.backup.restore.createTime': '创建时间',
  'pages.backup.restore.appCount': '应用数量',
  'pages.backup.restore.operations': '操作',
  'pages.backup.restore.restore': '还原',
  'pages.backup.restore.delete': '删除',
  'pages.backup.restore.restoring': '正在还原',
  'pages.backup.restore.restore_success': '还原成功',
  'pages.backup.restore.restore_fail': '还原失败',
  'pages.backup.restore.delete_success': '删除成功',
  'pages.backup.restore.delete_fail': '删除失败',
  'pages.backup.restore.confirmDelete': '确认要删除此备份吗？',
  'pages.backup.restore.confirmRestore': '确认要从此备份还原吗？这将覆盖现有数据。',
  'pages.backup.stats.appsImported': '导入应用',
  'pages.backup.stats.configsImported': '导入配置',
  'pages.backup.stats.appsUpdated': '更新应用',
  'pages.backup.stats.configsUpdated': '更新配置',
  'pages.backup.stats.errors': '错误数量',
