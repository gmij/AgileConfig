export default {
  ...
  'pages.backup.backup.title': 'Backup',
  'pages.backup.backup.create': 'Create Backup',
  'pages.backup.backup.creating': 'Creating backup',
  'pages.backup.backup.create_success': 'Backup created successfully',
  'pages.backup.backup.create_fail': 'Failed to create backup',
  'pages.backup.backup.directory': 'Backup Directory',
  'pages.backup.backup.latest': 'Latest Backup',
  'pages.backup.backup.appCount': ' apps',
  'pages.backup.backup.download': 'Download',
  'pages.backup.restore.title': 'Restore',
  'pages.backup.restore.upload': 'Upload Backup File',
  'pages.backup.restore.uploadTip': 'Click or drag file to this area to upload',
  'pages.backup.restore.uploadDesc': 'Only .zip backup files are supported',
  'pages.backup.restore.history': 'Backup History',
  'pages.backup.restore.fileName': 'File Name',
  'pages.backup.restore.fileSize': 'File Size',
  'pages.backup.restore.createTime': 'Create Time',
  'pages.backup.restore.appCount': 'App Count',
  'pages.backup.restore.operations': 'Operations',
  'pages.backup.restore.restore': 'Restore',
  'pages.backup.restore.delete': 'Delete',
  'pages.backup.restore.restoring': 'Restoring',
  'pages.backup.restore.restore_success': 'Restore successful',
  'pages.backup.restore.restore_fail': 'Restore failed',
  'pages.backup.restore.delete_success': 'Delete successful',
  'pages.backup.restore.delete_fail': 'Delete failed',
  'pages.backup.restore.confirmDelete': 'Are you sure you want to delete this backup?',
  'pages.backup.restore.confirmRestore': 'Are you sure you want to restore from this backup? This will overwrite existing data.',
  'pages.backup.stats.appsImported': 'Apps Imported',
  'pages.backup.stats.configsImported': 'Configs Imported',
  'pages.backup.stats.appsUpdated': 'Apps Updated',
  'pages.backup.stats.configsUpdated': 'Configs Updated',
  'pages.backup.stats.errors': 'Errors',
